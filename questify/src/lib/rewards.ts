import { Difficulty, QuestType, QuestTag } from '@prisma/client'

// 基础奖励规则
const BASE_REWARDS = {
  [Difficulty.EASY]: { exp: 20, gold: 5 },
  [Difficulty.MEDIUM]: { exp: 50, gold: 10 },
  [Difficulty.HARD]: { exp: 100, gold: 20 },
}

// 类型额外奖励
const TYPE_BONUS = {
  [QuestType.MAIN]: { exp: 20, gold: 5 },
  [QuestType.CHALLENGE]: { exp: 30, gold: 10 },
  [QuestType.DAILY]: { exp: 0, gold: 0 },
  [QuestType.SIDE]: { exp: 0, gold: 0 },
}
